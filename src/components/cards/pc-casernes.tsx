...
export default function PCCasernesCard({ onClose }: { onClose: () => void }) {
  const handleDownload = () => {
    const pdfUrl = "/fiches-pdf/CasernesCard.pdf"
    const link = document.createElement("a");
    link.href = pdfUrl;
    link.download = "CasernesCard.pdf";
    ...
    >
      ...
      >
        <div className="col-span-10">
          <h2 className="text-base sm:text-lg font-bold">PC Casernes</h2>
