...
export default function PCBeaufondsCard({ onClose }: { onClose: () => void }) {
  const handleDownload = () => {
    const pdfUrl = "/fiches-pdf/BeaufondsCard.pdf"
    const link = document.createElement("a");
    link.href = pdfUrl;
    link.download = "BeaufondsCard.pdf";
    ...
    >
      ...
      >
        <div className="col-span-10">
          <h2 className="text-base sm:text-lg font-bold">PC Beaufonds</h2>
