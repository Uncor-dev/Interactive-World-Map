...
export default function PCLeGolCard({ onClose }: { onClose: () => void }) {
  const handleDownload = () => {
    const pdfUrl = "/fiches-pdf/LeGolCard.pdf"
    const link = document.createElement("a");
    link.href = pdfUrl;
    link.download = "LeGolCard.pdf";
    ...
    >
      ...
      >
        <div className="col-span-10">
          <h2 className="text-base sm:text-lg font-bold">PC LeGol</h2>
