...
export default function SaintPhilippeCard({ onClose }: { onClose: () => void }) {
  const handleDownload = () => {
    const pdfUrl = "/fiches-pdf/SaintPhilippe.pdf"
    const link = document.createElement("a");
    link.href = pdfUrl;
    link.download = "saint-philippe-la-fillière-canne-sucre.pdf";
    ...
    >
      ...
      >
        <div className="col-span-10">
          <h2 className="text-base sm:text-lg font-bold">Saint-Philippe</h2>
      ...
      <CardContent>
        <div className="bg-white py-4 rounded-lg px-2 sm:px-4 text-xs sm:text-sm">
          <div className="px-2 sm:px-5 text-[#2D5F52] text-base sm:text-lg">
            <span className="text-lg sm:text-xl font-bold">48 000</span> tonnes de canne à sucre produites soit <span className="text-lg sm:text-xl font-bold">25%</span> de la production de la CASUD<sup>(1)</sup>
          </div>
          ...
          <div className="pt-4 grid grid-cols-12 items-center">
            ...
            <div className="col-span-10">
              <p>
                <span className="text-base sm:text-lg font-bold text-[#2D5F52]">1 200</span> ha de canne à sucre sur <span className="text-base sm:text-lg font-bold text-[#2D5F52]">840</span> ha de Surface Agricole Utile<sup>(1)</sup>
              </p>
            </div>
          </div>
          ...
          <div className="pt-4 grid grid-cols-12 items-center">
            ...
            <div className="col-span-10">
              <p>
                <span className="text-base sm:text-lg font-bold text-[#2D5F52]">100</span> exploitations cannières<sup>(1)</sup>
              </p>
            </div>
          </div>
          <div className="pr-10 sm:pr-80 pl-2 sm:pl-5 pt-4">
          ...
          <div className="pt-4 grid grid-cols-12 items-center">
            ...
            <div className="col-span-10">
              <p>
                <span className="text-base sm:text-lg font-bold text-[#2D5F52]">270</span> actifs agricoles dédiés à la canne à sucre<sup>(2)</sup>
              </p>
            </div>
          </div>
          <div className="pr-10 sm:pr-80 pl-2 sm:pl-5 pt-4">
          ...
          <div className="pt-4 grid grid-cols-12 items-center">
            ...
            <div className="col-span-10">
              <p>
                <span className="text-base sm:text-lg font-bold text-[#2D5F52]">65%</span> des exploitations cannières produisent également des fruits et légumes et font de l’élevage ce qui participe à la souveraineté alimentaire de l’île<sup>(1)</sup>
              </p>
            </div>
          </div>
          <div className="px-2 sm:px-5 pt-4">
