...
export default function BoisRougeCard({ onClose }: { onClose: () => void }) {
  const handleDownload = () => {
    const pdfUrl = "/fiches-pdf//////////////////////.pdf"
    const link = document.createElement("a");
    link.href = pdfUrl;
    link.download = "bois-rouge-la-fillière-canne-sucre.pdf";
    ...
    >
      ...
      >
        <div className="col-span-10">
          <h2 className="text-base sm:text-lg font-bold">Bois Rouge</h2>
