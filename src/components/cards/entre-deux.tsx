...
export default function EntreDeuxCard({ onClose }: { onClose: () => void }) {
  const handleDownload = () => {
    const pdfUrl = "/fiches-pdf/EntreDeux.pdf"
    const link = document.createElement("a");
    link.href = pdfUrl;
    link.download = "entre-deux-la-fillière-canne-sucre.pdf";
    ...
    >
      ...
      >
        <div className="col-span-10">
          <h2 className="text-base sm:text-lg font-bold">Entre-Deux</h2>
