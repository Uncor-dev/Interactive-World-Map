...
export default function PCBoisRougeCard({ onClose }: { onClose: () => void }) {
  const handleDownload = () => {
    const pdfUrl = "/fiches-pdf/BoisRougeCard.pdf"
    const link = document.createElement("a");
    link.href = pdfUrl;
    link.download = "BoisRougeCard.pdf";
    ...
    >
      ...
      >
        <div className="col-span-10">
          <h2 className="text-base sm:text-lg font-bold">PC BoisRouge</h2>
