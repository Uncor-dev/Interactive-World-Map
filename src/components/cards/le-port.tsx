...
export default function LePortCard({ onClose }: { onClose: () => void }) {
  const handleDownload = () => {
    const pdfUrl = "/fiches-pdf/LePort.pdf"
    const link = document.createElement("a");
    link.href = pdfUrl;
    link.download = "le-port-la-fillière-canne-sucre.pdf";
    ...
    >
      ...
      >
        <div className="col-span-10">
          <h2 className="text-base sm:text-lg font-bold">Le Port</h2>
